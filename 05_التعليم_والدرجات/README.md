1️⃣ النظام الرئيسي: التعليم والدرجات (System 05)

الهدف: إدارة كل شيء أكاديمي من الدرجات اليومية، الاختبارات، الواجبات، المحصلة الشهرية، حتى النتيجة النهائية والترتيب.

الفئات المستفيدة: إدارة، معلم، مطور.

المخرجات الأساسية: monthly_grades, semester_grades, annual_grades, annual_result.

خريطة الأنظمة الفرعية:

سياسات الدرجات – تعريف الأوزان، قواعد النجاح، تكليف المعلمين.

الاختبارات والفترات – إدارة الفترات ورصد الدرجات.

الواجبات المنزلية – تتبع التنفيذ لكل طالب.

المحصلة الشهرية – حساب آلي + عناصر يدوية.

نتائج الفصل والعام – تجميع + قرار النقل.

تحضير الدروس – متابعة جودة التحضير.

التدقيق والحوكمة – منع العبث بعد الاعتماد.

التقارير والمخرجات – توليد النسب والتقديرات والترتيب.

أدوات النسخ السنوي – نسخ إعدادات عام لآخر.

البيانات التجريبية – اختبار رحلة تشغيل كاملة.

دفتر المتابعة الذكي – توليد دفاتر المعلمين والفصول.

ملاحظات تشغيلية:

العملية تسير تسلسلياً: إعداد → إدخال يومي → حساب شهري → حساب فصلي → حساب سنوي → الحوكمة/التقارير.

المتغيرات الهامة للتشغيل:

@current_user_id → يسجل اسم المعدل.

@skip_teacher_assignment_check → لتجاوز التحقق عند الحاجة النظامية.
...
| 11 | دفتر المتابعة الذكي | توليد دفاتر المتابعة للمعلمين والفصول تلقائياً | `11_دفتر_المتابعة_الذكي/DDL.sql` | `11_دفتر_المتابعة_الذكي/README_SMART_NOTEBOOK.md` |
...
9. يمكن في أي وقت تشغيل النظام الفرعي 11 لتوليد دفاتر المتابعة الذكية.
