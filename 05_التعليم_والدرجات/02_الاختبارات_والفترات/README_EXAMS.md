2️⃣ نظام الاختبارات والفترات – Subsystem 02

🎯 الفكرة: إدارة دورة الاختبارات كاملة بسهولة وبدون أخطاء

إنشاء فترات امتحانية (شهري/نهائي/منتصف الفصل) بضغطة زر.

إدخال ومراجعة درجات الطلاب بدقة وشفافية.

قفل واعتماد الفترات لمنع أي تعديل بعد الاعتماد.

💡 لماذا المدارس تحبه؟

يقلل الأخطاء في إدخال الدرجات.

يضمن سير العملية بشكل سلس من الجدولة إلى الاعتماد.

يدعم اختبار صف كامل أو شعب محددة حسب الحاجة.

📊 مميزات إضافية:

ضوابط ذكية: سقف الدرجة، تكليف المعلم، منع التعديل بعد القفل.

تقارير فورية لحالة كل فترة امتحانية.

سجل كامل للدرجات لكل طالب مع ملاحظات المعلم.
