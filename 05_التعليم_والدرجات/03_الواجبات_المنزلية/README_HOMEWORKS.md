3️⃣ نظام الواجبات المنزلية – Subsystem 03

🎯 الفكرة: متابعة الواجبات من الإنشاء حتى دمجها في المحصلة الشهرية

إنشاء واجب لأي مادة وشعبة بسهولة.

متابعة تنفيذ كل طالب: تم/لم ينفذ، مع إمكانية إدخال درجة يدوية.

دمج النتائج تلقائيًا في المحصلة الشهرية.

💡 لماذا المدارس تحبه؟

يوفر الوقت على المعلمين في متابعة الطلاب.

يضمن توثيق كل الواجبات والدرجات بشكل منظم.

يعطي إشراف كامل على الالتزام والمواعيد النهائية.

📊 مميزات إضافية:

أنواع واجبات متعددة: واجب، بحث، مشروع، نشاط صفي…

حساب الدرجة الفعلية لكل طالب تلقائيًا.

تقارير جاهزة للاطلاع على مستوى التزام الطلاب.
